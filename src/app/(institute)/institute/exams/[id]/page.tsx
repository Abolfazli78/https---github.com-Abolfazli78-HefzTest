...
export default async function InstituteExamDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4">
                ...
                <Badge variant={exam.isActive ? "outline" : "secondary"} className={exam.isActive ? "text-indigo-600 border-indigo-200 bg-indigo-50" : ""}>
                    ...
                    <div className="mt-6 pt-6 border-t">
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="font-medium">{exam.createdBy?.name || "ناشناس"}</p>
                                <p className="text-xs text-muted-foreground">{exam.createdBy?.email || "بدون ایمیل"}</p>
                            </div>
                        </div>
                    </div>
