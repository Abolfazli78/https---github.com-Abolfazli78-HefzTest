...
export default async function InstituteStudentDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    // Get student details with exam attempts (institute can see all students under their management)
                ...
                <Card>
                    <CardContent className="text-center py-10">
                        ...
                        <p className="text-muted-foreground mb-4">
                            دانش‌آموز مورد نظر وجود ندارد یا تحت مدیریت موسسه شما نیست.
                        </p>
                        <Link href="/institute/students">
                            <Button>
    ...
    return (
        <div className="space-y-6">
            ...
            {student.teacher && (
                <Card>
                    <CardHeader>
                        <CardTitle className="text-lg">اطلاعات معلم</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-muted-foreground">{student.teacher.email}</p>
                            </div>
                        </div>
                    </CardContent>
                </Card>
                                ...
                                <div key={attempt.id} className="border rounded-lg p-4">
                                    <div className="flex items-center justify-between">
                                        <div>
                                            ...
                                            <p className="text-xs text-muted-foreground mt-1">
                                                توسط {attempt.exam.createdBy?.name || "سیستم"}
                                            </p>
                                            <p className="text-xs text-muted-foreground mt-1">
                                                {attempt.submittedAt 
