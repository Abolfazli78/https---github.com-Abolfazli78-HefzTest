  ...
  const steps = useMemo<Step[]>(
    () => [
      ...
      },
      {
        ...
        description: "وارد بخش ثبت‌نام شوید و اطلاعات خود را وارد کنید.",
        notes: ["نوع حساب خود را انتخاب کنید (کاربر عادی یا دانش آموز، معلم، مدیر موسسه)","نام و نام خانوادگی خود را کامل وارد کنید","در صورت تمایل ایمیل خود را وارد کنید","شماره موبایل خود را بدون صفر وارد کنید.  مثال: 9121112233"],
      ...
      },
      {
       ...
       title: "مرحله ۲: تکمیل اطلاعات و تایید",
        ...
        notes: ["رمز قوی انتخاب کنید.", "شرایط استفاده را مطالعه کنید.","کد تایید 4 رقمی پیامک شده وارد کنید","در آخر بر روی دکمه ایجاد حساب کاربر کلیک کنید تا حساب کاربری ساخته شود."],
      },
    ],
    []
  );
