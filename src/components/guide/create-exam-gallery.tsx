  ...
  return (
    <>
      <section className="min-h-[92vh] lg:grid lg:grid-cols-[35%_65%]" dir="rtl">
        <div className="order-2 lg:order-1 h-full flex flex-col justify-between px-6 py-8 md:px-8 md:py-10 lg:px-10 lg:py-12">
          <div>
          ...
          <div className="mt-8 hidden lg:flex items-center justify-between gap-3">
